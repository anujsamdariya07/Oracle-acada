  ...
  return (
    ...
    <header className="relative h-[500px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        />
        <h1 className="text-5xl font-bold text-white mb-4"> {/* Reduced margin-bottom */}
    ...
    <main className="container mx-auto px-4 py-8 -mt-16 relative z-10">
      ...
      <section className="bg-white rounded-xl p-8 mb-8 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
          <DateCard title="Registration Opens" date="February 13, 2024" />
          <DateCard title="Submission Deadline" date="TBD" />
      ...
      <section className="bg-[#F80000] rounded-xl p-8 mb-8 shadow-lg text-white">
        ...
        <span className='text-2xl font-bold'>Invitation to the OracleAcad Low-Code Development Contest</span><br />
        We are excited to announce the OracleAcad Low-Code Development Contest, an opportunity for all aspiring developers to showcase their skills and creativity! 
        <br />
        <br />
        ...
        <br />
        <br />
        <span className='text-2xl font-bold'>What to Expect:</span><br />
<span className='text-2xl font-bold'>1. Challenge:</span> Develop an innovative application that solves a real-world problem using the various services available through Oracle Cloud Infrastructure (OCI). <br />
<span className='text-2xl font-bold'>2. Mentoring Sessions:</span> All participants will receive guidance from Oracle officials to ensure your project is on the right track. <br />
<span className='text-2xl font-bold'>3. Prizes:</span> Exciting prizes await the winners! (Details to be announced soon, and prizes will be awarded by Oracle.) <br />
<span className='text-2xl font-bold'>4. OCI Credits:</span> Every participant will receive $300 in Oracle Cloud Infrastructure credits to help you build and deploy your application! <br />

<br />
<span className='text-2xl font-bold'>How to Participate:</span>
<br />
1. Register between February 11th - 14th. <br />
2. Develop your application using only Oracle Cloud Infrastructure. (Click Here) <br />
3. Submit your application through a presentation between February 18th - 21st. (Submission link will be shared soon) <br />
4. Top submissions will make it to the final round, where the best will be recognized! <br />
<br />
<span className='font-bold'>Don’t miss out on this opportunity to showcase your talent, receive expert guidance, and win amazing prizes! </span>

<br /><span className='font-bold'>Register now and get ready to build the future with Oracle!</span>
        </p>
